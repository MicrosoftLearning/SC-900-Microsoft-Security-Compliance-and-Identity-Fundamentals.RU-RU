...
1. Выберите **Обнаруженные приложения**. В окне обнаруженных приложений представлено более подробное представление обнаруженных приложений, включая оценку риска, трафик, количество пользователей и многое другое.
    ...
    1. При выборе определенного элемента строки откроется страница сведений для конкретного приложения.  Выберите элемент из списка и просмотрите сведения, доступные на странице обзора.  Для выбранного элемента перейдите на вкладку **"Использование** облачных** приложений", чтобы просмотреть более подробные сведения, включая **использование**, **пользователей, **IP-адреса** и **инциденты**. Завершив изучение страницы сведений, вернитесь на страницу обнаруженных приложений, выбрав **Cloud Discovery** в строке навигации в верхней части страницы.  Если выбрать Cloud Discovery на панели навигации слева, снова откроется представление панели мониторинга.
