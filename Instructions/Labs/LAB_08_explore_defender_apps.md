...
# Практическое занятие. Обзор Microsoft Defender для облачных приложений
...
1. Войдите с учетными данными администратора для клиента Microsoft 365.
...
1. Вы можете подключиться к приложениям напрямую путем настройки соединителей с приложениями, которые обеспечат более качественную видимость ваших облачных приложений и контроль за ними. В правом верхнем углу экрана выберите **Действия** , а затем выберите **Параметры Cloud Discovery**.  В левой части экрана в разделе «Подключенные приложения» выберите **Соединители приложений**.  
    ...
    1. На странице Подключенные приложения выберите **Office 365** в списке, чтобы просмотреть подробные сведения, а затем щелкните вертикальные многоточия в правой части экрана и выберите **Просмотр параметров соединителя приложений**, чтобы вернуться на страницу Соединители приложений. Если для Office 365 указывается ошибка подключения, скорее всего, не включен аудит.  Если аудит включен, перейдите к вертикальному многоточию в правой части элемента строки и выберите **Изменить параметры**.  Чтобы повторно подключиться, выберите **Подключить Office 365** в нижней части страницы. Теперь на странице должно отображаться, что Office 365 подключена. Нажмите кнопку **Готово**.  Теперь состояние будет отображаться с желтым предупреждающим знаком, указывающим на отсутствие недавнего состояния.  Обновление состояния займет некоторое время, так как период времени ретроактивной проверки зависит от конкретного приложения, а клиенты лаборатории могут столкнуться с более длительными задержками.

    1. Теперь вы настроите новый соединитель с приложением. Выберите **+Подключить приложение** и в раскрывающемся списке выберите **Microsoft Azure**.  Во всплывающем окне Microsoft Azure выберите **Подключить Microsoft Azure**, а затем нажмите кнопку **Готово**.  Вы увидите состояние подключения (если вы не видите его, обновите браузер). Выберите **Microsoft Azure** , чтобы просмотреть подробные сведения о сканировании пользователей, данных и действий.  Вернитесь на панель мониторинга Cloud Discovery, выбрав **Cloud Discovery** в разделе Облачные приложения на панели навигации слева.
...
1. Чтобы обеспечить защиту данных, Microsoft Defender for Cloud Apps позволяет просматривать все файлы из подключенных приложений, например все файлы, хранящиеся в SharePoint и Salesforce. В области навигации слева выберите и изучите параметр **Файлы** .
    ...
    1. Вернитесь к файлам, выбрав **Файлы** в списке облачных приложений на панели навигации слева. Как уже отмечалось, отображение файлов может занять несколько дней. После включения мониторинга файлов стоит отметить, что после перечисления файлов вы можете фильтровать данные по приложению, владельцу, уровню доступа, типу файлов и соответствующей политике. Кроме того, вы создаете новую политику на основе поиска и экспорта данных.
...
1. На панели навигации слева выберите **Политики**, а затем — **Управление политиками**.  Указанные политики предоставляют информацию о количестве оповещений, созданных политикой, их серьезности и т. д. Если выбрать любой элемент сроки, вы получите более подробную информацию о политике.
