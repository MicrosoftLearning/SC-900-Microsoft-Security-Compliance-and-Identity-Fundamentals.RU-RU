...
**Предполагаемое время**: 25-30 минут
...
1. Выберите **Изменить**.  Обратите внимание на две подгруппы: «Диспетчер по обнаружению электронных данных» и «Администратор по обнаружению электронных данных».  
    1. Страница "Управление диспетчером по обнаружению электронных данных" позволяет добавлять пользователей к роли диспетчера по обнаружению электронных данных. На этом практическом занятии мы добавим участников в подгруппу "Администратор обнаружения электронных данных", поэтому нажмите **Далее**.
...
1. В разделе "Решения" на панели навигации слева выберите **Обнаружение электронных данных**, а затем **Стандарт**.
