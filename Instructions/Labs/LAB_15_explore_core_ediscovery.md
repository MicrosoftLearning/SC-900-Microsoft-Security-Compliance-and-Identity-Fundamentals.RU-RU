---
lab:
    title: 'Практическое занятие. Изучение рабочего процесса eDiscovery стандарт'    
    module: 'Модуль 5. Сведения о возможностях обнаружения электронных данных и аудита в Microsoft Purview'
---
...
1. В списке имен выберите **Администратор MOD**, **Megan Bowen**, затем выберите **Добавить** в нижней части страницы и нажмите **Готово** в нижней части страницы.

1. Убедитесь, что добавлены нужные участники, а затем нажмите кнопку **Сохранить**.
