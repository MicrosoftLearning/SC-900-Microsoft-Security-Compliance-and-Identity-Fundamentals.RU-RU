---
lab:
  title: Изучение управления внутренними рисками в Microsoft 365
...
ms.locfileid: "137894191"
---
# <a name="lab-explore-insider-risk-management-in-microsoft-365"></a>Практическое занятие. Изучение управления внутренними рисками в Microsoft 365
...
1. На панели навигации в левой части Центра соответствия требованиям Microsoft 365 выберите пункт **Разрешения**.
...
#### <a name="task-3-in-this-task-you-will-walk-through-the-settings-associated-with-the-insider-risk-management-solution--insider-risk-management-settings-apply-to-all-insider-risk-management-policies-regardless-of-the-template-you-choose-when-creating-a-policy"></a>Задача 3. В рамках этой задачи вы изучите параметры, Связанные с решением по управлению внутренними рисками.  Параметры по управлению внутренними рисками относятся ко всем политикам управления внутренними рисками независимо от шаблона, выбранного при создании политики. 
...
#### <a name="task-4--in-this-task-you-will-walk-through-the-creation-of-a-policy"></a>Задача 4.  В рамках этой задачи вы создадите политику.
