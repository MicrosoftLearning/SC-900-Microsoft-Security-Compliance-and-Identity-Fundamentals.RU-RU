...
1. Откройте браузер Microsoft Edge. В адресной строке введите **[admin.microsoft.com](https://admin.microsoft.com)** и войдите с помощью учетных данных Microsoft 365, предоставленных полномочным поставщиком услуг размещения заданий (ALH).
    ...
    1. Так как это первый вход, вам может потребоваться настроить MFA. Следуйте инструкциям на экране, чтобы настроить MFA.
...
1. Теперь вы должны успешно войти в учетную запись Майкрософт Сара.  Обратите внимание, что лицензирование Сара, назначенное в предыдущей задаче, ограничено только Power Automate Free и Power Apps для разработчиков и не включало лицензирование E5.

1. Выполните выход, щелкнув значок в правом верхнем углу окна Microsoft 365, который отображается в виде круга с буквами SP (рядом со значком вопросительного знака), а затем выберите **Выйти**. Закройте браузер.
