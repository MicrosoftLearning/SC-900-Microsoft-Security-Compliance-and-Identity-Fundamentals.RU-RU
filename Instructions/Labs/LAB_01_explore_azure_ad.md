<!---
---
Практическое занятие. Заголовок: "Знакомство с Параметрами пользователей Microsoft Entra ID" Схема обучения/Модуль/Урок: "Схема обучения: Описание возможностей Microsoft Entra; Модуль 1: Описание типов функций и удостоверений идентификатора Microsoft Entra; Урок 3: Описание типов удостоверений Microsoft Entra"
---
--->

# Практическое занятие: Знакомство с Microsoft Entra ID
