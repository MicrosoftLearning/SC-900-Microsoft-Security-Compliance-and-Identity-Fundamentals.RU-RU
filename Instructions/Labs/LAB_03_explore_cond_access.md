---
lab:
    title: 'Практическое занятие. Знакомство с управлением доступом в Azure AD с использованием условного доступа'    
    module: 'Описание возможностей управления доступом Azure AD Урок'
---
