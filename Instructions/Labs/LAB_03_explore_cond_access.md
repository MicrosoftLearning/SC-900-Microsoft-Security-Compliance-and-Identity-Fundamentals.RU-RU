...
1. Теперь вы попытаетесь выполнить вход в приложение, которое соответствует требованиям многофакторной проверки подлинности.  Откройте Microsoft Edge и в адресной строке введите **portal.azure.com**.
