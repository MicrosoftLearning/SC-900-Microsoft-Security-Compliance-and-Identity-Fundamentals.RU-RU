...
1. Выполните вход в качестве пользователя Debra Burger. 
...
1. Теперь вы попытаетесь выполнить вход в приложение, которое соответствует требованиям многофакторной проверки подлинности. Откройте новую вкладку в Microsoft Edge и в адресной строке введите **portal.azure.com**.
