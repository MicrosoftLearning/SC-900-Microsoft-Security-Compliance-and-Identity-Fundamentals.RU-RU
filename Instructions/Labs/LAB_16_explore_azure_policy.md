...
# Практическое занятие. Ознакомиться с порталом Azure
...
1. Начните с вкладки "Основы".
    ...
    1. В поле Определение политики нажмите **кнопку с многоточием**.  Появляется список доступных определений политик.  В строке поиска введите **Требовать тег**. В результатах поиска выберите **Требовать тег в группе ресурсов** (возможно, потребуется прокрутить вниз) и нажмите кнопку **Добавить**.  Примечание. Действие этой политики заключается в запрете создания любой новой группы ресурсов, которая не соответствует требованиям.  
...
1. Теперь вы попадете на вкладку "Сообщения о несоответствии требованиям". В поле сообщения о несоответствии введите **Требуется тег среды**, а затем нажмите кнопку **Далее**. Примечание. Это сообщение будет отображаться как причина несоответствия для групп ресурсов, созданных до назначения политики и не имеющих тега Среды.
...
В этой задаче вы выполните действия по исправлению группы ресурсов, не соответствующей требованиям. ПРИМЕЧАНИЕ. Подписка Azure, используемая для лаборатории, будет испытывать более длительные задержки, чем обычно, чтобы обновить состояние соответствия для исправленной группы ресурсов.
