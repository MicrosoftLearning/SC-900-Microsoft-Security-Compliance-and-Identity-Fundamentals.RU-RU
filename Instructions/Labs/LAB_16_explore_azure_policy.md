...
В рамках этой задачи вы создадите базовое назначение политики, требующее, чтобы группы ресурсов помечались тегом.
...
1. Оставьте параметры исправления по умолчанию без изменений, а затем нажмите кнопку **Далее**.
...
В рамках этой задачи вы оцените воздействие назначения политики Azure. Для этого надо будет создать группу ресурсов в Azure, которая не имеет тега, затем вы увидите, что будет при обновлении группы ресурсов для включения тега.  Примечание. Вступление в действие политики, созданной на предыдущем шаге, может занять до 30 минут, хотя, как правило, это происходит быстрее.
