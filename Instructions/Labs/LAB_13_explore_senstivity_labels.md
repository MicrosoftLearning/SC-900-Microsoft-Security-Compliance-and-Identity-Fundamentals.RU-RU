...
# <a name="lab-explore-sensitivity-labels-in-microsoft-purview"></a>Практическое занятие. Изучение меток конфиденциальности в Microsoft Purview
...
1. Обратите внимание на область действия этой метки.  Для области задано значение **Элементы**.  Прочтите описание, но ничего не меняйте.  В нижней части страницы нажмите кнопку **Далее**.

1. Для выбранной области действия («Элементы») можно настроить шифрование и (или) маркировку содержимого.  Обратите внимание на то, как устанавливаются параметры безопасности для файлов и сообщений эл. почты, которые относятся как к шифрованию содержимого этих файлов, так и к их маркировке.  Рассмотрите определения этих параметров.  Ничего не меняйте.  В нижней части страницы нажмите кнопку **Далее**.
...
1. В следующем окне определяются параметры защиты групп и сайтов, к которым применена данная метка. Параметр не включен, нажмите **Далее** в нижней части страницы.

1. В следующем окне представлена предварительная версия функции автоматического добавления меток для ресурсов схематизированных данных. прочитайте описание.  Эта функция не включена. Выберите **Отмена** в нижней части страницы, чтобы закрыть мастер настройки меток и вернуться на страницу защиты информации.
...
1. В верхней части окна выберите **Правка**.
    ...
    1. Просмотрите параметры политики.  Выбрать **Требовать, чтобы пользователи добавляли метку к своим электронным письмам и документам**. Просмотрите приведенное описание. В нижней части страницы нажмите кнопку **Далее**.
    1. Прочитайте описание в разделе «Применить метку по умолчанию к документам». В поле «Метка по умолчанию» щелкните стрелку вниз, а затем выберите **Общие/Все сотрудники (без ограничений)** .  В нижней части страницы нажмите кнопку **Далее**.
...
В этой задаче вы выполните процесс применения метки с точки зрения пользователя (в данном случае пользователь является администратором) и ознакомитесь с процессом маркировки содержимого, созданным с помощью меток.
...
1. Выберите **+ Новый пустой документ**, затем введите в этом документе какой-нибудь текст.  В верхней части страницы нажмите стрелку вниз рядом с надписью «Документ — Сохранен», затем в поле «Имя файла» введите **Тестовая метка**. На клавиатуре нажмите клавишу **ВВОД**.
