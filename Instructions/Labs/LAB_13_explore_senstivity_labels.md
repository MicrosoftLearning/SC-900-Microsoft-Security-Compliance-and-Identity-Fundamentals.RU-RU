...
ms.locfileid: "142614450"
---
# <a name="lab-explore-sensitivity-labels-in-microsoft-365"></a>Практическое занятие. Изучение меток конфиденциальности в Microsoft 365
...
#### <a name="task-1-in-this-task-you-will-gain-an-understanding-of-what-sensitivity-labels-can-do-by-going-through-the-settings-for-an-existing-sensitivity-label-that-have-been-created-and-the-corresponding-policy-to-publish-the-label"></a>Задача 1. В рамках этой задачи вы познакомитесь с возможностями применения меток конфиденциальности, настроив параметры уже созданной метки конфиденциальности и соответствующую политику по публикации метки.
...
1. Просмотрите параметры политики.  Не меняйте какие-либо параметры.  В нижней части страницы нажмите кнопку **Далее**.
    1. Прочитайте описание в разделе "Применить метку по умолчанию к документам".  Обратите внимание, что метка по умолчанию отсутствует. Не меняйте какие-либо параметры.  В нижней части страницы нажмите кнопку **Далее**.
    1. Прочитайте описание в разделе "Применить метку по умолчанию к сообщениям электронной почты".  Щелкните стрелку раскрывающегося списка в поле ввода, чтобы просмотреть доступные параметры. Не меняйте какие-либо параметры.  В нижней части страницы нажмите кнопку **Далее**.
    1. Прочитайте описание в разделе "Применить метку по умолчанию к содержимому Power BI".  Обратите внимание, что метка по умолчанию отсутствует. Не меняйте какие-либо параметры.  В нижней части страницы нажмите кнопку **Далее**.
