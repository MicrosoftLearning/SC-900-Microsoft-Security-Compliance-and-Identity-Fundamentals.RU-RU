...
1. В верхней строке меню выберите значок **Конфиденциальность**, значок справа от значка микрофона (в зависимости от размера экрана, возможно, потребуется сначала выбрать значок многоточия, а затем конфиденциальности). В верхней части страницы появится желтый баннер, а в правом верхнем углу отобразится кнопка «Выбрать метку».  Нажмите кнопку **Выбрать метку**.  Откроется всплывающее окно.   Нажмите **Выбрать метку** и в раскрывающемся списке выберите **Конфиденциально. Финансы**, а затем нажмите кнопку **ОК**.  
