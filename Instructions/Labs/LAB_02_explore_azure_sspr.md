...
В рамках этой задачи вы в качестве администратора должны добавить существующего пользователя Adele Vance в группу SSPRSecurityUsers.  Кроме того, вам необходимо будет сбросить пароль пользователя, чтобы потом выполнить вход под этим пользователем и зарегистрироваться для самостоятельного сброса пароля.
...
4. Поскольку это ваш первый вход от имени Adele Vance, появится запрос на сброс пароля.  Введите старый пароль.  В качестве нового пароля введите **SC900-Lab**. В поле подтверждения пароля введите **SC900-Lab**.  Выберите **Войти**.  Примечание. Мы используем этот пароль только для удобства выполнения практического занятия. Рекомендуется ввести более надежный пароль.
