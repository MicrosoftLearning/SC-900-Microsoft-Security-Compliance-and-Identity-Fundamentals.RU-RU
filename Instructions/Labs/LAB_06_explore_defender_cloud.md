<!---
---
Лабораторная работа. Заголовок: "Изучение Microsoft Defender для облака" Схема обучения/Модуль/Урок: "Схема обучения: описание возможностей решений майкрософт по обеспечению безопасности; Модуль 2. Описание возможностей управления безопасностью в Azure; Урок 3. Описание управления состоянием облачной безопасности
---
--->
...
1. Вы должны быть домашней страницей для служб Azure.  Если вы ранее закрыли браузер, ppen Microsoft Edge. В адресной строке введите **portal.azure.com** и войдите с учетными данными администратора.
...
1. В верхней части страницы выберите **Оцененные ресурсы**. 
...
1. На панели навигации слева выберите **Рекомендации**.  
    ...
    1. В списке выберите элемент.  На открывающейся странице вы увидите описание и дополнительные сведения, которые могут включать шаги по исправлению, затронутые ресурсы и многое другое. Закройте эту страницу, нажав **X** в правом верхнем углу экрана.

1. На главной левой панели навигации выберите **Соответствие нормативным требованиям**.  **ПРИМЕЧАНИЕ.** Если вы видите, что нет подписки для вычисления соответствия, это связано с тем, что может быть задержка до 24 часов для отображения информации. Перейти к задаче 2.  Если вы видите сведения, перейдите к дальнейшим действиям.
