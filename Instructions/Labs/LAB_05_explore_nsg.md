...
1. На панели навигации слева выберите **Параметры сети**.  В основных разделах главного окна отображается сетевой интерфейс для виртуальной машины.  Обратите внимание, что рядом с элементом "Группа безопасности сети" нет ничего, так как для интерфейса не назначена группа безопасности сети.
