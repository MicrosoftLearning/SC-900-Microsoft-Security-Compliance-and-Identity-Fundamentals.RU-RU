...
ms.locfileid: "141605428"
---
# <a name="lab-explore-azure-network-security-groups-nsgs"></a>Практическое занятие. Изучение групп безопасности сетей Azure (NSG).
...
#### <a name="task-1--in-this-task-you-will-create-a-windows-10-virtual-machine"></a>Задача 1.  В рамках этой задачи вы создадите виртуальную машину Windows 10.    
...
1. На вкладке «Основные» заполните приведенные ниже сведения (если что-то не указано, оставьте настройки по умолчанию):
    ...
    3. Образ: выберите **Windows 10 Pro, версия 20H2, поколение 1** в раскрывающемся списке.
    4. Размер: нажмите **Просмотреть все размеры** в раскрывающемся списке и выберите **B2S**, а затем нажмите **Выбрать** в нижней части страницы.
    5. Имя пользователя:  введите любое имя пользователя.  Запишите его, так как оно понадобится для доступа к виртуальной машине.
    6. Пароль:  введите пароль на свое усмотрение.  Запишите его, так как он понадобится для доступа к виртуальной машине.
    7. Общедоступные входящие порты: выберите **Нет**.
    8. Лицензирование: установите флажок **Подтверждаю, что имею действующую лицензию Windows 10 с правами размещения на нескольких клиентах**.
    9. По завершении выберите **Next: Диски**. 
...
#### <a name="task-2--create-a-network-security-group-and-assign-the-network-interface-of-the-vm-to-that-nsg"></a>Задача 2.  Создайте группу безопасности сети и назначьте этой группе сетевой интерфейс ВМ.
...
#### <a name="task-3-in-this-task-you-will-create-a-nsg-rule-to-allow-inbound-traffic-using-rdp-on-port-3389--you-will-then-test-that-rule-by-attempting-to-connect-to-the-vm-using-rdp"></a>Задача 3. В рамках этой задачи вы создадите правило NSG, чтобы разрешить входящий трафик RDP на порт 3389.  Затем вы проверите это правило, попытавшись подключиться к ВМ через RDP. 
...
#### <a name="task-4--the-default-outbound-rules-for-nsg-allow-outbound-internet-traffic-so-you-will-validate-that-you-can-connect-to-the-internet--you-will-then-go-through-the-process-of-creating-a-custom-outbound-rule-to-block-outgoing-internet-traffic-and-test-that-rule"></a>Задача 4.  Правила для исходящего трафика, которые по умолчанию применяются для группы, разрешают исходящий интернет-трафик, поэтому вы будете проверять возможность выхода в Интернет.  Затем вы создадите пользовательское правило исходящего трафика для блокировки исходящего трафика в Интернет и проверите это правило.
...
#### <a name="task-5--important-in-this-task-you-will-delete-the-resource-group-and-all-the-resources-it-contains---this-is-important-to-avoid-additional-charges"></a>Задача 5.  ВАЖНО. В рамках этой задачи вы удалите группу ресурсов и все содержащиеся в ней ресурсы.   Это важно во избежание дополнительных затрат.
