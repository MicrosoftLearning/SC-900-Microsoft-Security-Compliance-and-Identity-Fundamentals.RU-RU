...
1. Вернитесь на вкладку **SC900-WinWM — Microsoft Azure** в браузере.  Обновите страницу. Рядом с элементом "Группа безопасности сети" теперь должно отображаться имя только что созданной группы безопасности сети.  Если вы по-прежнему не видите его, подождите еще минуту, а затем снова обновите страницу.
