...
#### <a name="demo-part-1--explore-the-microsoft-365-defender-landing-page"></a>Демонстрация, часть 1.  Изучите целевую страницу Microsoft 365.
...
#### <a name="demo-part-2-in-this-part-of-the-demo-you-will-show-how-microsoft-secure-score-can-help-an-organization-improve-its-security-posture"></a>Демонстрация, часть 2. В этой части демонстрации вы покажете, как Оценка безопасности Майкрософт поможет организации повысить уровень своей безопасности.
