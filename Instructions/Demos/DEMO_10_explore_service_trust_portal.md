<!---
---
Демонстрация: Заголовок: "Service Trust Portal" Схема обучения/Модуль/Урок: "Схема обучения: описание возможностей соответствия требованиям Майкрософт; Модуль 1. Описание портала Service Trust от Майкрософт и возможностей обеспечения конфиденциальности; Урок 2. Изучение портала Service Trust Portal
---
--->
...
- Модуль. Описание портала Service Trust и возможностей конфиденциальности корпорации Майкрософт
...
1. На домашней странице Service Trust Portal прокрутите вниз до категории **Ресурсы для организации** . Выберите элемент **Ресурсы для вашей организации**.  Обратите внимание, что все перечисленные здесь документы зависят от подписки и разрешений вашей организации.
...
1. Закройте открытые вкладки браузера для портала Service Trust Portal и Центра управления безопасностью.
