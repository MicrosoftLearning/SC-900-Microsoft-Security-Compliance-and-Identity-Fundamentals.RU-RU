<!---
---
Демонстрация: Заголовок: "Microsoft Entra самостоятельного сброса пароля (SSPR)" Схема обучения/модуль/урок: "Схема обучения: описание возможностей Microsoft Entra; Модуль 2. Описание возможностей проверки подлинности идентификатора Microsoft Entra; Урок 4. Описание самостоятельного сброса пароля
---
--->

# Демонстрация: Microsoft Entra самостоятельного сброса пароля (SSPR)
