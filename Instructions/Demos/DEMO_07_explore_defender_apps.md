...
1. Если вы впервые посещаете портал Microsoft 365 Defender, вы можете увидеть всплывающее окно с кратким обзором.
...
1. Находясь на странице параметров облачных приложений, стоит потратить несколько минут на изучение некоторых других параметров Cloud Discovery.  
    ...
    1. Выберите Microsoft Information Protection, проговорите доступные параметры.
...
1. Чтобы обеспечить защиту данных, Microsoft Defender для облачных приложений позволяет просматривать все файлы из подключенных приложений, например все файлы, хранящиеся в SharePoint и Salesforce. На панели навигации слева выберите и изучите параметр **Файлы**.
    ...
    1. Вернитесь к файлам, выбрав **Файлы** в разделе облачных приложений на панели навигации слева. Возможно, вы ничего не увидите, потому что может пройти несколько дней, прежде чем появится список файлов, но стоит отметить, что после этого вы сможете фильтровать данные по приложению, владельцу, уровню доступа, типу файла и соответствующей политике. Также вы создаете новую политику на основе поиска и экспорта данных.
...
1. На панели навигации слева выберите **Главная**, чтобы вернуться на главную страницу Microsoft 365 Defender.
