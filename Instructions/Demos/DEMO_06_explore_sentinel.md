...
В этой части демонстрации вы просмотрите процесс подключения Microsoft Sentinel к вашему источнику данных для запуска сбора данных.
...
В этой части демонстрации описан процесс настройки книги для Office 365 для визуализации и мониторинга данных.
...
### <a name="demo-part-5"></a>Демонстрация, часть 5.

В этой части демонстрации описаны некоторые варианты, доступные в Sentinel.
