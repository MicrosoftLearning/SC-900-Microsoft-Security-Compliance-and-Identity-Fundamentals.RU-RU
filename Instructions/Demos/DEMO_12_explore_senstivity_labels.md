...
На этом этапе будет продемонстрирован процесс применения метки с точки зрения пользователя (в данном случае пользователь является администратором) и просмотр маркировки содержимого, созданной с помощью меток.

1. На главной странице портала соответствия требованиям Microsoft Purview выберите **значок средства запуска приложений** рядом с надписью Contoso Electronics. **Щелкните правой кнопкой мыши значок Word** и выберите **Открыть в новой вкладке**.  
